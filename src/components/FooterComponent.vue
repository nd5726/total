<template>
    <footer class="main-container bg-[#907B6E] bg-opacity-50 py-12 flex flex-col items-center justify-center">
        <p class="text-white font-normal tracking-wider text-base text-center">妥妥的、踏實的、穩穩的<br>把夢想變成細細品嚐的作品</p>
